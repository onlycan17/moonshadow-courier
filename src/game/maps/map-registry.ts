...
const mapDefs = {
  ...
  'endurance-forest': mapDef({
    ...
    platforms: [
      ...
      platform('lower-step-1', 520, 1200, 150),
      platform('lower-step-2', 780, 1160, 160),
      platform('lower-step-3', 1080, 1210, 170),
      platform('lower-step-4', 1380, 1140, 180),
      platform('lower-middle', 1600, 1070, 190),
      platform('middle-step-1', 1280, 1010, 180),
      platform('middle-step-2', 980, 950, 170),
      platform('middle-step-3', 680, 1000, 160),
      platform('middle-step-4', 360, 920, 180),
      platform('middle-left', 150, 850, 180),
      platform('upper-step-1', 440, 790, 160),
      platform('upper-step-2', 740, 850, 170),
      platform('upper-step-3', 1040, 770, 180),
      platform('upper-step-4', 1340, 830, 160),
      platform('upper-right', 1600, 750, 180),
      platform('summit-step-1', 1290, 690, 150),
      platform('summit-step-2', 980, 640, 160),
      platform('summit-approach', 1260, 580, 210),
      platform('summit', 1540, 660, 220)
    ],
    ropes: [
      rope('entry-rope', 520, 1120, 1260),
      rope('middle-rope', 1180, 860, 1040),
      rope('upper-rope', 520, 700, 920),
